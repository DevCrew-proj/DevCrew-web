      ...
      <Toolbar>
        ...
        >
          ...
          <SortOptions show={showSortOptions}>
            <SortOption onClick={() => handleSort('left')}>Left Align</SortOption>
            <SortOption onClick={() => handleSort('center')}>Center Align</SortOption>
            <SortOption onClick={() => handleSort('right')}>Right Align</SortOption>
          </SortOptions>
        </ToolbarItem>
        <ToolbarItem
