    ...
    <Container>
      <InnerContainer>
        ...
        <FormRow>
          ...
          <FormInput />
          <HelperText>팀으로 가입하기 위해 팀원이 입력해야하는 비밀번호(4자리 이상의 숫자)를 입력하여 주십시오.</HelperText>
        </FormRow>
        <FormDivider />
        <FormRow>
          <FormLabelContainer>
          ...
          <FormInput />
          <HelperText>팀장을 포함한 팀 최대 인원 수를 입력하여 주십시오. 0 입력시 제한없음으로 설정됩니다.</HelperText>
        </FormRow>
        <FormDivider />
        <FormRow>
          <FormLabelContainer>
        ...
        <FormRow>
          ...
          <DropdownContainer>
            <DropdownButton onClick={toggleDropdown}>
              ...
              <DropdownIcon src={isDropdownOpen ? DropUpArrow : DropdownArrow} alt="Dropdown Arrow" />
            </DropdownButton>
            {isDropdownOpen && (
              <DropdownList>
                <DropdownListItem onClick={() => handleOptionClick('iOS')}>iOS</DropdownListItem>
                <DropdownListItem onClick={() => handleOptionClick('AOS')}>AOS</DropdownListItem>
              </DropdownList>
            )}
          </DropdownContainer>
        </FormRow>
