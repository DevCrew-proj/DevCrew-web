...
const ContestCheck = () => {
    ...
    const fetchContests = async () => {
        try {
            ...
            console.log(
                "Fetching contests with URL:",
                `https://devcrew.kr/api/v1/contests/?sector=${sector}&page=${
                    currentPage - 1
                }&size=${itemsPerPage}&sort=createdAt&order=desc`
            );
            const response = await axios.get(
                    ...
                    return (
                        ...
                        >
                            ...
                            <Contents>
                                ...
                                <ContestDday>
                                    D-{dayDifference >= 0 ? dayDifference : 0}
                                </ContestDday>{" "}
                                {/* D-Day 표시 */}
                            </Contents>
                        </ResultItem>
